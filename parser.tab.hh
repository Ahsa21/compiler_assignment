  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_MAIN = 4,                              // MAIN
        S_INTTYPE = 5,                           // INTTYPE
        S_FLOATTYPE = 6,                         // FLOATTYPE
        S_VOLATILE = 7,                          // VOLATILE
        S_BOOLEAN = 8,                           // BOOLEAN
        S_VOID = 9,                              // VOID
        S_IF = 10,                               // IF
        S_ELSE = 11,                             // ELSE
        ...
        S_GE = 42,                               // GE
        S_NE = 43,                               // NE
        S_COMPARISON = 44,                       // COMPARISON
        S_NEWLINE = 45,                          // NEWLINE
        S_ID = 46,                               // ID
        S_INT = 47,                              // INT
        S_FLOAT = 48,                            // FLOAT
        ...
        S_opt_newlines = 52,                     // opt_newlines
        S_var = 53,                              // var
        S_expr_list = 54,                        // expr_list
        S_opt_init = 55,                         // opt_init
        S_type = 56,                             // type
        S_stmtEnd = 57,                          // stmtEnd
        S_opt_expr = 58,                         // opt_expr
        S_var_list = 59,                         // var_list
        S_class_list = 60,                       // class_list
        S_class_decl = 61,                       // class_decl
        S_class_body = 62,                       // class_body
        S_method = 63,                           // method
        S_param_list = 64,                       // param_list
        S_param_list_nonempty = 65,              // param_list_nonempty
        S_newline_list = 66,                     // newline_list
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      make_INTTYPE ()
      {
        return symbol_type (token::INTTYPE);
      }
#else
      static
      symbol_type
      ...
      make_FLOATTYPE ()
      {
        return symbol_type (token::FLOATTYPE);
      }
#else
      static
      symbol_type
      ...
      make_ASSIGNCOLON ()
      {
        return symbol_type (token::ASSIGNCOLON);
      }
#else
      static
      symbol_type
      ...
      make_COMPARISON ()
      {
        return symbol_type (token::COMPARISON);
      }
#else
      static
      symbol_type
